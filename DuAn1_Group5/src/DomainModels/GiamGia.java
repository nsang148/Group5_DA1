...
public class GiamGia {
    ...
    public GiamGia(String Id, String Ma, String Ten, Date NgayBatDau, Date NgayKetThuc, int MucPhanTramGiamGia, String DieuKienGiamGia, int TrangThai) {
        this.Id = Id;
        this.Ma = Ma;
        this.Ten = Ten;
    ...
    public String toString() {
        return "GiamGia{" + "Id=" + Id + ", Ma=" + Ma + ", Ten=" + Ten + ", NgayBatDau=" + NgayBatDau + ", NgayKetThuc=" + NgayKetThuc + ", MucPhanTramGiamGia=" + MucPhanTramGiamGia + ", DieuKienGiamGia=" + DieuKienGiamGia + ", TrangThai=" + TrangThai + '}';
    }
