...
public class ViDiemModel {
    ...
    public ViDiemModel(String id, int tongDiem, int soDiemDaDung, int soDiemDaCong, boolean trangThai) {
        this.id = id;
    ...
    public ViDiemModel(int tongDiem, int soDiemDaDung, int soDiemDaCong, boolean trangThai) {
        this.tongDiem = tongDiem;
        this.soDiemDaDung = soDiemDaDung;
        this.soDiemDaCong = soDiemDaCong;
        this.trangThai = trangThai;
    ...
    public Object[] toRowData(){
        return new Object[]{id, tongDiem, soDiemDaDung, soDiemDaDung, trangThai ? "KHTT" : "KHKTT"};
    }
}
