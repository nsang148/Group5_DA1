...
public class ThitService implements IThitService {
    ...
    public List<ThitView> getAll() {
        ...
        for (ThitDomain x : list) {
            ThitView view = new ThitView(x.getId(), x.getMa(), x.getTen(),x.getIdLT(), x.getTrangthai());
            ds.add(view);
        }
        return ds;
    }
    ...
    public boolean add(ThitView tv) {
        ThitDomain domain = new ThitDomain(tv.getId(), tv.getMa(), tv.getTen(),tv.getIdLT(), tv.getTrangthai());
    ...
    public boolean delete(ThitView tv) {
        ThitDomain xxd = new ThitDomain(tv.getId(), tv.getMa(), tv.getTen(),tv.getIdLT(), tv.getTrangthai());
