...
public class HopThitView {
    ...
    public HopThitView(String id) {
        this.id = id;
    }

    public HopThitView(String id, String ma, String TenHopThit, Double GiaBan, int SoLuongTon, float KhoiLuong, Date NgayDongGoi, Date HSD, String MoTa, int TrangThai, String idThit, String idloaiThit, String idXuatXu, String idNCC, Double GiaConLai) {
        this.id = id;
        this.ma = ma;
